...
![如果图片无法读取，查看PDF文件](https://github.com/zhaoyangjue/algorithm010/blob/master/Week01/homework-QueueAndPriorityQueue/QueueExtends.jpg)

其实现类或接口：

![如果图片无法读取，查看PDF文件](https://github.com/zhaoyangjue/algorithm010/blob/master/Week01/homework-QueueAndPriorityQueue/Queue-implements.jpg)
...
![如果图片无法读取，查看PDF文件](https://github.com/zhaoyangjue/algorithm010/blob/master/Week01/homework-QueueAndPriorityQueue/offer.jpg)

poll()图示

![如果图片无法读取，查看PDF文件](https://github.com/zhaoyangjue/algorithm010/blob/master/Week01/homework-QueueAndPriorityQueue/poll.jpg)

remove(E e)图示

![如果图片无法读取，查看PDF文件](https://github.com/zhaoyangjue/algorithm010/blob/master/Week01/homework-QueueAndPriorityQueue/remove.jpg)
