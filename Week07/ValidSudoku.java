...
public class ValidSudoku {
  public static void main(String[] args) {
    ...
    boolean validSudoku1 = solution.isValidSudoku(otherBoard);
  ...
  class Solution {
    ...
    public boolean isValidSudoku(char[][] board) {
      boolean[][] rows = new boolean[NUM][NUM];
      boolean[][] cols = new boolean[NUM][NUM];
      boolean[][] boxes = new boolean[NUM][NUM];
